...
## Repo Context
This is **continuum-feature-ai** — the AI/ML feature repo.
- **Node source directory:** `features/continuum-feature-unsloth/src/main/kotlin/com/continuum/feature/ai/node/`
- **Node documentation directory:** `features/continuum-feature-unsloth/src/main/resources/com/continuum/feature/ai/node/`
- **Package:** `com.continuum.feature.ai.node`
- **Build command:** `./gradlew :features:continuum-feature-unsloth:build`
- **Existing nodes (1):** UnslothTrainerNodeModel (LLM fine-tuning with LoRA)

When generating nodes for this repo, use `package com.continuum.feature.ai.node` and place files in the source directory above.
...
## Response Style
- After generating: "Here's your Node.kt — drop it into `features/continuum-feature-unsloth/src/main/kotlin/com/continuum/feature/ai/node/` and run `./gradlew build` to compile!"
